...
public class GroupControllerTest {
    ...
    private static final String THROW_GET_GROUP_END_POINT = "/groups/-1";
    ...
    private static final String THROW_DELETE_END_POINT = "/groups/-1";
    ...
    void shouldThrow404WhileGetting() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(THROW_GET_GROUP_END_POINT)).andExpect(MockMvcResultMatchers.status().is(404));
    }
