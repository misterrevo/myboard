...
public class PostControllerTest {
    ...
    private static final String THROW_GET_END_POINT = "/posts/-1";
    ...
    private static final String SHOULD_SEARCH_END_POINT = "/posts/testGet/search";
    private static final Object SHOULD_SEARCH_TITLE = "testGet";

    private static final String CREATE_END_POINT = "/posts";
    private static final String SHOULD_CREATE_CONTENT = "testCreate";
    private static final String SHOULD_CREATE_TITLE = "testCreate";
    ...
    private static final String THROW_DELETE_END_POINT_MODERATOR = "/posts/-1";
    private static final String THROW_DELETE_END_POINT_USER = "/posts/1";

    private static final String SHOULD_EDIT_END_POINT = "/posts/4";
    private static final String THROW_EDIT_END_POINT_MODERATOR = "/posts/-1";
    ...
    void shouldCreatePost() throws Exception {
        ...
        createDTO.setTitle(SHOULD_CREATE_TITLE);
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(CREATE_END_POINT)
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.title").value(SHOULD_CREATE_TITLE))
    ...
    void shouldThrow404WhileDeletingAsModerator() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete(THROW_DELETE_END_POINT_MODERATOR).header(AUTHORIZATION_HEADER,
    ...
    void shouldThrow404WhileEditingAsModerator() throws Exception {
        ...
        editDTO.setContent(SHOULD_EDIT_CONTENT);
        String json = objectMapper.writer().withDefaultPrettyPrinter().writeValueAsString(editDTO);
        mockMvc.perform(MockMvcRequestBuilders.patch(THROW_EDIT_END_POINT_MODERATOR)
                        .header(AUTHORIZATION_HEADER, Utils.getTokenForModerator(mockMvc, objectMapper))
                        .contentType(Utils.APPLICATION_JSON_UTF8).content(json))
                .andExpect(MockMvcResultMatchers.status().is(404));
    }
    ...
    void shouldGiveLike() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post(SHOULD_LIKE_END_POINT).header(AUTHORIZATION_HEADER,
    ...
    void shouldThrow400WhileGivingLike() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post(THROW_LIKE_END_POINT).header(AUTHORIZATION_HEADER,
    ...
    void shouldRemoveLike() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete(SHOULD_UNLIKE_END_POINT).header(AUTHORIZATION_HEADER,
                Utils.getTokenForUser(mockMvc, objectMapper))).andExpect(MockMvcResultMatchers.status().is(204));
    }

    @Test
    void shouldThrow404WhileRemovingLike() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete(THROW_UNLIKE_END_POINT).header(AUTHORIZATION_HEADER,
                Utils.getTokenForUser(mockMvc, objectMapper))).andExpect(MockMvcResultMatchers.status().is(404));
    }
