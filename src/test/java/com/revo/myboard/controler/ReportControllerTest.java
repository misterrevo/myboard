...
public class ReportControllerTest {
    ...
    private static final String THROW_GET_END_POINT_USER = "/reports/1";
    private static final String THROW_GET_END_POINT_MODERATOR = "/reports/-1";

    private static final String SHOULD_POST_END_POINT = "/reports/post/1";
    private static final String SHOULD_POST_CONTENT = "testReportPost";
    private static final String THROW_POST_END_POINT = "/reports/post/-1";
    private static final String THROW_POST_CONTENT = "";

    private static final String SHOULD_COMMENT_END_POINT = "/reports/comment/1";
    private static final String THROW_COMMENT_END_POINT = "/reports/comment/-1";
    private static final String SHOULD_COMMENT_CONTENT = "testReportComment";
    private static final String THROW_COMMENT_CONTENT = "";

    private static final String ROLE_MODERATOR = "MODERATOR";
    private static final String ROLE_ADMIN = "ADMIN";

    private static final String SHOULD_CHECKED_END_POINT = "/reports/1";
    private static final String THROW_NULL_CHECKED_END_POINT = "/reports/-1";
    ...
    private static final String THROW_DELETE_END_POINT = "/reports/-1";
    ...
    void shouldThrow404WhileGettingAsUser() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(THROW_GET_END_POINT_USER).header(AUTHORIZATION_HEADER,
    ...
    void shouldThrow404WhileGettingAsModerator() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(THROW_GET_END_POINT_MODERATOR).header(AUTHORIZATION_HEADER,
    ...
    void shouldThrow400WhileReportingPost() throws Exception {
        var contentDTO = new ContentDTO();
        contentDTO.setContent(THROW_POST_CONTENT);
        String json = objectMapper.writer().withDefaultPrettyPrinter().writeValueAsString(contentDTO);
        mockMvc.perform(MockMvcRequestBuilders.post(SHOULD_POST_END_POINT)
                        .header(AUTHORIZATION_HEADER, Utils.getTokenForUser(mockMvc, objectMapper))
                        .contentType(Utils.APPLICATION_JSON_UTF8).content(json))
    ...
    void shouldThrow400WhileReportingComment() throws Exception {
        var contentDTO = new ContentDTO();
        contentDTO.setContent(THROW_COMMENT_CONTENT);
        String json = objectMapper.writer().withDefaultPrettyPrinter().writeValueAsString(contentDTO);
        mockMvc.perform(MockMvcRequestBuilders.post(SHOULD_COMMENT_END_POINT)
                        .header(AUTHORIZATION_HEADER, Utils.getTokenForUser(mockMvc, objectMapper))
                        .contentType(Utils.APPLICATION_JSON_UTF8).content(json))
    ...
    void shouldSetCheckedReport() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.patch(SHOULD_CHECKED_END_POINT))
    ...
    void shouldThrow404WhileChecking() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.patch(THROW_NULL_CHECKED_END_POINT))
                .andExpect(MockMvcResultMatchers.status().is(404));
    }
    ...
    void shouldThrow404WhileDeleting() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete(THROW_DELETE_END_POINT))
                .andExpect(MockMvcResultMatchers.status().is(404));
    }
