...
public class AuthControllerTest {
    ...
    private static final String SHOULD_LOGIN_LOGIN = "test";
    private static final String SHOULD_LOGIN_PASSWORD = "test";
    private static final String THROW_UNAUTHORIZED_LOGIN_LOGIN = "testError";
    private static final String THROW_UNAUTHORIZED_LOGIN_PASSWORD = "testError";
    ...
    private static final String SHOULD_REGISTER_LOGIN = "register";
    private static final String SHOULD_REGISTER_PASSWORD = "register";
    private static final String THROW_REGISTER_EMAIL = "erroremail";

    private static final String RESEND_END_POINT = "/resend-code";
    private static final String SHOULD_RESEND_EMAIL = "game-tspeak@wp.pl";
    ...
    private static final String SHOULD_ACTIVE_CODE = "4849538f-db9e-4159-ad91-8815878e433f";
    private static final String THROW_INVALID_ACTIVE_CODE = "4849538f";
    private static final String THROW_NULL_ACTIVE_CODE = "4849538f-XXXX-4159-ad91-8815878e433f";

    private static final String ACTIVE_END_POINT_ADMIN = "/adminActive";
    private static final String ADMIN_ROLE = "ADMIN";
    private static final String THROW_NULL_END_POINT_ADMIN = "/notExistsUser";
    private static final String THROW_INVALID_END_POINT_ADMIN = "/test";
    ...
    void shouldLoginUser() throws Exception {
        ...
        credentialsDTO.setLogin(SHOULD_LOGIN_LOGIN);
        credentialsDTO.setPassword(SHOULD_LOGIN_PASSWORD);
    ...
    void shouldThrow401WhileLoging() throws Exception {
        var credentialsDTO = new CredentialsDTO();
        credentialsDTO.setLogin(THROW_UNAUTHORIZED_LOGIN_LOGIN);
        credentialsDTO.setPassword(THROW_UNAUTHORIZED_LOGIN_PASSWORD);
        String json = objectMapper.writer().withDefaultPrettyPrinter().writeValueAsString(credentialsDTO);
        mockMvc.perform(
                        MockMvcRequestBuilders.post(LOGIN_END_POINT).contentType(Utils.APPLICATION_JSON_UTF8).content(json))
    ...
    void shouldRegisterUser() throws Exception {
        ...
        registerDTO.setLogin(SHOULD_REGISTER_LOGIN);
        registerDTO.setPassword(SHOULD_REGISTER_PASSWORD);
        ...
        mockMvc.perform(
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.login").value(SHOULD_REGISTER_LOGIN))
