...
public class SectionControllerTest {
    ...
    private static final String THROW_GET_END_POINT = "/sections/-1";
    ...
    private static final String THROW_DELETE_END_POINT = "/sections/-1";
    ...
    private static final String THROW_NULL_RENAME_END_POINT = "/sections/-1";
