...
public class CategoryControllerTest {
    ...
    private static final String THROW_GET_END_POINT = "/categories/-1";

    private static final String SHOULD_DELETE_END_POINT = "/categories/2";
    private static final String THROW_DELETE_END_POINT = "/categories/-1";

    private static final String SHOULD_RENAME_END_POINT = "/categories/3";
    private static final String THROW_NULL_RENAME_END_POINT = "/categories/-1";
